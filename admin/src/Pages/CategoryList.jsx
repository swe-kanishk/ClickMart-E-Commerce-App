    ...
    <>
      <div className="flex items-center px-2 py-0 mt-3 justify-between">
        ...
        <div className="col flex items-center justify-end gap-3 ml-auto">
            ...
            <Button onClick={() => context.setIsOpenFullScreenPannel({open: true, model: 'Add New Category'})} className="!bg-blue-600 !font-medium !py-[6px]  !text-[13px] !px-[14px] !text-white gap-2 !capitalize">
