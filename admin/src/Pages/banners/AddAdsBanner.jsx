...
function AddAdsBanner() {
  ...
  const validValue = ((formFields.catId || formFields.subCatId || formFields.thirdLevelSubCatId) && formFields?.images?.length > 0);
  ...
  const handleSubmit = (e) => {
    ...
    setIsLoading(true);
    postData("/api/adsBanner", formFields, { withCredentials: true }).then(
      (res) => {
        console.log(res)
        if (res?.success === true) {
