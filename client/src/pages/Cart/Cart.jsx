      ...
      <div className="container w-[80%] max-w-[80%] flex gap-5">
        ...
        <div className="right-col w-[30%]">
          <div className="shadow-md rounded-md mb-10 p-5 bg-white">
              ...
              <Button className="!bg-red-500 hover:!bg-black gap-2 !flex !items-center !w-full !text-white !capitalize !font-medium !mt-4">Checkout <FaBagShopping size={'16px'} /></Button>
          </div>
        </div>
      </div>
    </section>
